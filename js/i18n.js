...
(function(){
  ...
  const EN = {
    ...
    titulo_bc_apresentacao: "Business Card - Presentation",
    desc_bc_apresentacao: "Physical presentation of the INVERNØ business card, front and back.",
    titulo_bc_caixa: "Business Card - Box",
    desc_bc_caixa: "Premium box presentation mockup for the INVERNØ business card.",
  ...
  const ES = {
    ...
    subsec_cartoes_mockups: "Tarjetas de Visita & Mockups",
    titulo_bc_frente: "Tarjeta de Visita - Frente",
    desc_bc_frente: "Frente de la tarjeta de visita de INVERNØ, desarrollada como extensión de la identidad visual de la banda.",
    ...
    titulo_bc_apresentacao: "Tarjeta de Visita - Presentación",
    desc_bc_apresentacao: "Presentación física de la tarjeta de visita de INVERNØ, frente y reverso.",
    titulo_bc_caixa: "Tarjeta de Visita - Caja",
    desc_bc_caixa: "Simulación de la caja premium de presentación de la tarjeta de visita de INVERNØ.",
  ...
  const FR = {
    ...
    subsec_cartoes_mockups: "Cartes de Visite & Mockups",
    ...
    titulo_bc_apresentacao: "Carte de Visite - Présentation",
    desc_bc_apresentacao: "Présentation physique de la carte de visite INVERNØ, recto et verso.",
    titulo_bc_caixa: "Carte de Visite - Boîte",
    desc_bc_caixa: "Simulation de la boîte premium de présentation de la carte de visite INVERNØ.",
